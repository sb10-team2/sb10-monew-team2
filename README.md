[2팀 모뉴 노션](https://www.notion.so/Codeit-Sprint-10-2-34065902e5ef813291c7d113c0765d37?source=copy_link) 
...
# MoNew
  ...
  **알림 도메인 (Notification)**
  - 이벤트 기반 알림 생성 구현
    - 멀티 스레드를 사용하여 응답 속도 향상
  - 부하 테스트 및 테스트 데이터 생성
    - `data-generator`, `load-test`, `monitoring` 멀티 모듈 생성
  - K6 기반 부하 테스트 구현 및 결과 레포트 생성
  - 테스트용 대용량 데이터 생성기 구현
  - 유닛 및 슬라이스 테스트 시 필요한 테스트 객체 생성 구현
